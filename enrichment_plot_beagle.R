...
png("beagle_essential.png",width = 900, height = 875)
...
png("beagle_nonessential.png",width = 900, height = 550)
...
# ## DRAW LEGEND
png("legend_beagle.png",width = 600, height = 600)
